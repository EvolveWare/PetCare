...
ActiveRecord::Schema[7.1].define(version: 2024_09_24_070742) do
  ...
  create_table "vaccine_records", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "vet_visits", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "pet_id", null: false
    t.date "visit_date"
    t.string "reason"
    t.datetime "created_at", null: false
